...
============================================================================ */
/* 5041 Training Hub script: FRC-trainings/modules/inclusion.js
...
// STUDENT NOTE: Function `formatAudioTime` groups one reusable behavior. Keep one clear responsibility per function so future students can test and modify it safely.
...
// STUDENT NOTE: UI/state helper `updateAudioButton`. It updates page content or control state to match the current application data.
...
// STUDENT NOTE: UI/state helper `updateMuteButton`. It updates page content or control state to match the current application data.
...
// STUDENT NOTE: Function `stopSlideAudio` groups one reusable behavior. Keep one clear responsibility per function so future students can test and modify it safely.
...
// STUDENT NOTE: Function `loadAudioForSlide` groups one reusable behavior. Keep one clear responsibility per function so future students can test and modify it safely.
function loadAudioForSlide(slide) {
  ...
  */
  ...
  // STUDENT NOTE: Event listener for `loadedmetadata`. The callback below runs whenever that user/browser event occurs.
  ...
  // STUDENT NOTE: Event listener for `timeupdate`. The callback below runs whenever that user/browser event occurs.
  ...
  // STUDENT NOTE: Event listener for `play`. The callback below runs whenever that user/browser event occurs.
  slideAudio.addEventListener("play", () => {
    updateAudioButton();
  });


  // STUDENT NOTE: Event listener for `pause`. The callback below runs whenever that user/browser event occurs.
  slideAudio.addEventListener("pause", () => {
    updateAudioButton();
  });


  // STUDENT NOTE: Event listener for `ended`. The callback below runs whenever that user/browser event occurs.
